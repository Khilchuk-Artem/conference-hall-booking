...
- створювати, переглядати бронювання
- формувати звіти за вибраний період

Для бронювань діють встановлено обмеження:
...
Повторний запит із тим самим ключем і тим самим тілом повертає збережену відповідь.
